    ...
    <footer className="bg-orange-50 border-t border-primary/20 text-foreground py-12 px-6 mt-auto w-full">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-8 items-center text-base font-bold text-foreground/80">
          ...
          <a href="https://www.instagram.com/swarajyaratna" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors bg-pink-500/10 px-4 py-2 rounded-full text-pink-600">Instagram</a>
          <a href="https://chat.whatsapp.com/FT7Te9tfUe69MZlKaZxec8" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors bg-green-500/10 px-4 py-2 rounded-full text-green-600">WhatsApp Community</a>
        </div>
      </div>
